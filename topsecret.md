...
Причины три:
* Ты должен сам выбрать свою профессию. Выпускники ФИТ не все поголовно разработчики, в IT множество разных профессий на любой вкус.
* Тебя невозможно подготовить к тому, что будет на будущей работе. Даже к тому времени, когда утверждено содержание курса, множество вещей может измениться. Есть полезные области знания, которые особо не изменяются, им в университете обычно и обучают. Например, курсы алгоритмов, операционных систем или реляционной алгебры напрямую при промышленном написании кода используются не постоянно, но без их понимания сложность некоторых задач вырастает на порядки.
* Computer science и Software development не просто разные словосочетания, это в корне разные вещи. Первое – это наука, а второе – ремесло. Цель университета – дать представление о науке и научить думать. Цель ремесла же – сделать жизнь людей проще.
...
### Нужно научиться эффективно работать с клавиатурой
Работа такая, что приходится много работать с текстом. Львиная доля времени, конечно, уходит на чтение, но когда нужно писать, _необходимо_ сделать так, чтобы ничто не отвлекало. Особенно существование клавиатуры.
...
Опционально можно попробовать альтернативные раскладки клавиатуры (_не_ QWERTY). Для английского языка очень хороша [colemak](https://colemak.com/), пользоваться ей одно удовольствие. К сожалению, относительно популярной хорошей русской раскладки нет (хотя Диктор и Зубачёва были многообещающими). Зато есть [типографская раскладка](https://ilyabirman.ru/projects/typography-layout/).
