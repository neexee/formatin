...
* В низкоуровневые игры с байтами часто гораздо удобнее играть в командной строке. Манипуляции с байтами в GUI часто равносильны печати на клавиатуре в варежках.
* При определённом уровне навыка пользователь командной строки на порядки эффективнее пользователя графического приложения. Командная строка легко автоматизируется. Ходить по выпадающим меню программно или вручную очень сложно.
